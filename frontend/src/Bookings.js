...
function Bookings() {
    ...
    return (
        ...
        >
            ...
            <div style={{ padding: '20px', maxWidth: '1000px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
                <h1 style={{ marginBottom: '20px', textAlign: 'center', color: '#fff' }}>Study Room Bookings</h1>
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '20px', marginBottom: '25px', justifyContent: 'center' }}>
                    <div>
                        <label htmlFor="floorSelect" style={{ color: '#fff' }}>Floor</label>
                    ...
                    <div>
                        <label htmlFor="timeSelect" style={{ color: '#fff' }}>Time</label>
                    ...
                    <div>
                        <label htmlFor="dateSelect" style={{ color: '#fff' }}>Date</label>
                ...
                <div>
                    <h2 style={{ textAlign: 'center', color: '#fff' }}>Available Rooms</h2>
                    {selectedFloor === '1' ? (
                        <p style={{ textAlign: 'center', color: '#fff' }}>No study rooms available on Floor 1.</p>
                    ) : loading ? (
                        <p style={{ textAlign: 'center', color: '#fff' }}>Loading Rooms...</p>
                    ) : error ? (
                        <p style={{ color: 'red', textAlign: 'center' }}>{error}</p>
                    ) : availableRooms.length === 0 ? (
                        <p style={{ textAlign: 'center', color: '#fff' }}>No available rooms on Floor {selectedFloor} at {selectedTime}.</p>
                    ) : (
